...
my_packages <- c("tidyverse","readxl","factoextra","agricolae","agridat","lmerTest","lme4","sjPlot","skimr","ggtext","exrafont","correlation","metan","fontawesome","emoji","devtools","multcomp","writexl","pastecs","rsthemes","esquisse","here","gridExtra","psych","emmeans")
